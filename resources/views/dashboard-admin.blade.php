...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- 🎉 Success Messages --}}
            @if (session('success'))
                <div class="mb-6 bg-green-100 border-l-4 border-green-500 text-green-700 px-4 py-3 rounded-lg shadow-sm animate-pulse"
                    role="alert">
                    <div class="flex">
            ...
            {{-- ℹ️ Info Messages --}}
            @if (session('info'))
                <div class="mb-6 bg-blue-100 border-l-4 border-blue-500 text-blue-700 px-4 py-3 rounded-lg shadow-sm"
                    role="alert">
                    <div class="flex">
                        <span class="text-xl mr-2"></span>
                        <p>{{ session('info') }}</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div
                    class="bg-gradient-to-br from-blue-500 to-blue-600 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                    <div class="flex items-center justify-between">
                ...
                <div
                    class="bg-gradient-to-br from-green-500 to-green-600 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                    <div class="flex items-center justify-between">
                        <div class="text-white">
                ...
                {{-- Card 3: Terlambat --}}
                <div
                    class="bg-gradient-to-br from-yellow-500 to-yellow-600 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                    <div class="flex items-center justify-between">
                        <div class="text-white">
                ...
                {{-- Card 4: Izin/Sakit --}}
                <div
                    class="bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                    <div class="flex items-center justify-between">
                        <div class="text-white">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            @forelse ($recentActivities as $activity)
                                <div
                                    class="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg hover:shadow-md transition-shadow border border-gray-200">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">
                                                @if ($activity->time_in && $activity->time_out)
                                                    Absen Pulang pada <span
                                                        class="font-medium">{{ $activity->time_out }}</span>
                                                @elseif($activity->time_in)
                                                    Absen Masuk pada <span
                                                        class="font-medium">{{ $activity->time_in }}</span>
                                                @else
                                    ...
                                    <div>
                                        ...
                                        @endphp
                                        <span
                                            class="px-3 py-1 text-xs font-semibold rounded-full border {{ $badgeColor }}">
                                            {{ $activity->status }}
                                        </span>
                                    </div>
                                </div>
                            @empty
                                <div class="flex flex-col items-center py-12">
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">Data akan muncul setelah karyawan mulai absen
                                    </p>
                                </div>
                            @endforelse
                        </div>
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl">
                    <div class="p-6">
                        ...
                        @else
                            ...
                            <div
                                class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-4 rounded-lg">
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="mt-3 pt-3 border-t border-blue-200">
                                            <p class="text-xs text-blue-600">
                                                Waktu sekarang: <span
                                                    class="font-semibold">{{ $currentTime->format('H:i') }} WITA</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
